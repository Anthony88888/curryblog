...
def login(request):
    ...
    access_token_url = 'https://api.weibo.com/oauth2/access_token?client_id=%s&grant_type=authorization_code&redirect_uri=http://www.yoursite.com/login&code=%s' %(settings.CLIENT_ID, settings.APP_SECRET, code)
